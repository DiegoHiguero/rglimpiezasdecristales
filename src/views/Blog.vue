<template>
  <div class="blog-wrap">
    ...
    <div class="blog-hero">
      ...
      <p class="blog-sub">Guías prácticas para mantener tus cristales y escaparates en perfecto estado durante todo el año.</p>
    </div>
...
.blog-cta-btn--outline { background: var(--white); color: var(--blue); border: 1.5px solid var(--blue); }
