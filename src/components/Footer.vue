  ...
  <footer>
    <div class="ft-inner">
      <div class="ft-top">
        ...
        <div class="ft-col">
          <h3 class="ft-heading">Navegación</h3>
          <ul>
            ...
            <li><router-link to="/limpieza-cristales-altura">Limpieza en altura</router-link></li>
      ...
      <div class="ft-bottom">
        <span class="ft-copy">
          ...
          <router-link v-if="!userStore.userData?.email" to="/login" class="ft-login-ghost" tabindex="-1" aria-label="Iniciar sesión">
...
.ft-col ul li { display: flex; align-items: center; gap: 9px; margin-bottom: 12px; font-size: 0.84rem; color: #94a3b8; }
.ft-col ul li a, .ft-col ul li span { color: #94a3b8; text-decoration: none; transition: color 0.2s; }
.ft-col ul li a:hover { color: var(--white); }
.ft-icon { color: #94a3b8; font-size: 0.78rem; flex-shrink: 0; width: 14px; }
.ft-friend-item { display: block !important; }
.ft-friend-link { display: inline-flex; align-items: center; gap: 10px; text-decoration: none; color: #94a3b8; transition: color 0.2s; }
...
.ft-copy, .ft-location { font-size: 0.75rem; color: #94a3b8; }
.ft-login-ghost { color: #94a3b8; text-decoration: none; margin-left: 8px; font-size: 0.75rem; transition: color 0.2s; }
...
.ft-weather-msg { font-size: 0.72rem; color: #94a3b8; white-space: nowrap; }
