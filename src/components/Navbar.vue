...
.navbar.scrolled {
  ...
  box-shadow: 0 1px 0 rgba(255, 255, 255, 0.05) inset, 0 12px 32px -8px rgba(0, 0, 0, 0.5);
}
...
.nl:hover::after { width: calc(100% - 24px); }
.nl.router-link-exact-active {
  color: #fff;
}
.nl.router-link-exact-active::after { width: calc(100% - 24px); }
