...
const CLIENTES_HEADERS = ['Nombre / Razón social', 'NIF/CIF', 'Dirección', 'Teléfono', 'Email', 'Persona contacto', 'Notas', 'Precio habitual', 'Categoria']
